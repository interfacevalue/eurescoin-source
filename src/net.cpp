...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EuresCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"88.150.205.161", "88.150.205.161"},
    {"93.115.29.95", "93.115.29.95"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EuresCoin is probably already running."), addrBind.ToString().c_str());
        else
